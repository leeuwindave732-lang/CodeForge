import { ArrowRight, Zap, BookOpen, Lightbulb, Target, CheckCircle, Rocket } from "lucide-react";
        ...
        <div className="bg-gradient-to-br from-sage-50 to-sage-100 rounded-2xl overflow-hidden h-96 md:h-[500px] flex flex-col items-center justify-center relative border border-sage-200">
          ...
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
            <div className="text-center">
              <h3 className="font-serif text-3xl font-bold text-white mb-2">Interactive Learning Experience</h3>
              <p className="text-gray-200 font-medium">Hands-on projects, real-world scenarios, and expert-led tutorials</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <a href="/languages" className="text-sm text-gray-400 hover:text-white transition block mb-2">Languages</a>
              <a href="/tips" className="text-sm text-gray-400 hover:text-white transition block mb-2">Tips & Tricks</a>
              <a href="/techniques" className="text-sm text-gray-400 hover:text-white transition block">Techniques</a>
            </div>
            <div>
